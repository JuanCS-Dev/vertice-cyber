    ...
    <div className="flex flex-col gap-6">
      ...
      {result ? (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          {/* Intelligence & Control Hub */}
          <div className="flex flex-col gap-6">

            {/* C2 CARD */}
            <AgentControlCard
              agentId="cybersec_agent"
              agentType="CYBERSEC RECON"
            />
            ...
            <div className="bg-primary/5 border border-primary/10 rounded-lg p-0 overflow-hidden flex flex-col h-[300px]">
              <div className="px-4 py-2 bg-black/20 border-b border-primary/10">
                <h4 className="text-[10px] font-bold text-primary uppercase tracking-widest">Neural Link: CYBERSEC</h4>
              </div>
              <div className="flex-1 min-h-0">
                <LiveTerminal filter="cybersec_agent" />
              </div>
            </div>

            {/* Web Info (Collapsed if not active) */}
            {scanWeb && (
              <div className="bg-black/20 rounded-xl border border-white/5 overflow-hidden">
                <div className="px-4 py-3 border-b border-white/5 bg-white/5 flex items-center gap-2">
