        ...
        <div className="lg:col-span-5 flex flex-col gap-4">
          ...
          {result ? (
            <div className="flex flex-col gap-4">
              {/* C2 CARD */}
              <AgentControlCard
                agentId="patch_validator"
                agentType="PATCH VALIDATOR"
              />
              ...
              {/* NEURAL STREAM */}
              <div className="bg-primary/5 border border-primary/10 rounded-lg p-0 overflow-hidden flex flex-col h-[200px]">
                <div className="px-4 py-2 bg-black/20 border-b border-primary/10">
                  <h4 className="text-[10px] font-bold text-primary uppercase tracking-widest">Neural Link: PATCH</h4>
                </div>
                <div className="flex-1 min-h-0">
                  <LiveTerminal filter="patch_validator" />
                </div>
              </div>
