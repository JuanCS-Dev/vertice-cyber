...
VERTEX_AI_AVAILABLE = (
    ...
    or os.path.exists("/home/juan/.config/gcloud/application_default_credentials.json")
)
...
@pytest.mark.skipif(
    not VERTEX_AI_AVAILABLE, reason="Vertex AI credentials not available"
)
...
class TestAIIntegratedAssessment:
    ...
    def test_ai_integrated_assessment_quick(self, client: TestClient):
        ...
        response = client.post(
            ...
            json={
                "tool_name": "ai_integrated_assessment",
                "arguments": {"target": "web-application", "assessment_scope": "quick"},
            },
        )
