...
pytestmark = pytest.mark.skipif(
    not os.path.exists(
        "/home/juan/.config/gcloud/application_default_credentials.json"
    ),
...
class TestGemini3DirectAPI:
    ...
    def test_gemini3_basic_generation(self):
        ...
        client = genai.Client(vertexai=True, project="vertice-ai", location="global")
    ...
    def test_gemini3_threat_analysis(self):
        ...
        context = {
            ...
            "current_controls": {"mfa": True, "waf": True, "ids": False},
        }
        ...
        response = client.post(
            ...
            json={
                ...
                "arguments": {
                    "target": "cloud-infrastructure",
                    "framework": "soc2",
                    "current_state": {"encryption": True, "mfa": True, "logging": True},
                },
            },
        )
